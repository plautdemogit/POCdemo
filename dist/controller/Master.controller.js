/*global history */
sap.ui.define([
		"namespace1/controller/BaseController",
		...
		"sap/ui/Device",
		"namespace1/model/formatter",
		"namespace1/model/grouper",
		...
		return BaseController.extend("namespace1.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("namespace1.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Ktwrt", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Ktwrt", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var context = {
							Bukrs : mParams.firstListitem.getBindingContext().getProperty("Bukrs"),
							Ebeln : mParams.firstListitem.getBindingContext().getProperty("Ebeln").toString()
						};
						this.getRouter().navTo("object", context, true);
					}.bind(this),
					function (mParams) {
						if (mParams.error) {
							return;
			...
			_showDetail : function (oItem) {
				...
				var context = {
					    ...
					    Ebeln : oItem.getBindingContext().getProperty("Ebeln").toString()
						};
				this.getRouter().navTo("object", context, bReplace);
			},
