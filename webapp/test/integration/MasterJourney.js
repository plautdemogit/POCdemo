sap.ui.define([
		...
		opaTest("MasterList Filtering on Ktwrt less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<Ktwrt>").
				and.iSelectListItemInViewSettingsDialog("<100 <Waers>").
		...
		opaTest("MasterList Filtering on Ktwrt more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <Waers>").
				and.iPressOKInViewSelectionDialog();
