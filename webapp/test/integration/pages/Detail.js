							...
							success : function (aEntitySet) {
								...
								return this.waitFor({
									...
									check: function (oList) {
										...
										var sObjectID = oList.getBindingContext().getProperty("Bukrs");

										var iLength = aEntitySet.filter(function (oLineItem) {
											return oLineItem.Bukrs === sObjectID;
										}).length;
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								return this.waitFor({
									id : "lineItemsHeader",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name: "text", value: "<npHeadToItemPlural> (" + iNumberOfItems + ")"}),
									success : function () {
